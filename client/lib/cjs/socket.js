...
exports.useWebsocket = exports.SocketProvider = exports.makeid = exports.API_ENDPOINT_HOSTNAME = void 0;
var react_1 = require("react");
var unstated_next_1 = require("unstated-next");
/** API Endpoint Host */
exports.API_ENDPOINT_HOSTNAME = window.location.host;
...
var UseWebsocket = function () {
    var _a = (0, react_1.useState)(SocketState.CLOSED), state = _a[0], setState = _a[1];
    var callbacks = (0, react_1.useRef)({});
    var onconn = (0, react_1.useRef)([]);
    var webSocket = (0, react_1.useRef)(null);
    var send = (0, react_1.useRef)(function send(key, payload) {
    ...
    var setupWS = (0, react_1.useMemo)(function () {
    ...
    var connect = (0, react_1.useMemo)(function () {
        return function () {
            return new Promise(function (resolve, _) {
                setState(WebSocket.CONNECTING);
                setTimeout(function () {
                    webSocket.current = new WebSocket("".concat(protocol(), "://").concat(exports.API_ENDPOINT_HOSTNAME, "/api/ws"));
...
var WebsocketContainer = (0, unstated_next_1.createContainer)(UseWebsocket);
exports.SocketProvider = WebsocketContainer.Provider;
exports.useWebsocket = WebsocketContainer.useContainer;
exports.default = WebsocketContainer;
